...
blob_fixups: blob_fixups_user_type = {
    ...
    (
        "vendor/bin/hw/android.hardware.gnss@2.1-service-mediatek",
    ...
    "vendor/lib64/lib3a.flash.so": blob_fixup()
        .patchelf_version(patchelf_version)
        .add_needed("liblog.so"),
    ('vendor/lib64/hw/vendor.mediatek.hardware.pq@2.6-impl.so', 'vendor/bin/hw/vendor.mediatek.hardware.pq@2.2-service'): blob_fixup()
    ...
    "vendor/lib64/libtranssion_bodybeauty.so": blob_fixup()
