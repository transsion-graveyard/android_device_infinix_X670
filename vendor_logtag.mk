...
PRODUCT_VENDOR_PROPERTIES += \
    ...
    persist.log.tag.FileUtils=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.SatelliteController=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.libprocessgroup=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.BackgroundInstallControlService=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.PowerManagerService=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.ion=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.fpCoreHal=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.TEE=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.android.system.suspend-service=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.ProcessFreezerManager=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.ccci_mdinit=$(VENDOR_LOG_LEVEL) \
    persist.log.tag.ImeiPreference=$(VENDOR_LOG_LEVEL) \
